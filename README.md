...
**[Skills](https://github.com/zeroes-ones/Skills)** is a collection of **188 production-ready skills** across 27 domains covering the full company lifecycle — CEO vision through architecture, development, security, compliance, and operations. Agent-agnostic and compatible with Claude Code, Copilot CLI, Cursor, OpenClaw, and Gemini CLI.

| What's inside         |                                                               |
| --------------------- | ------------------------------------------------------------- |
| **188 skills**         | Engineering, leadership, product, security, data, growth      |
| **27 domains**        | Strategy, design, architecture, DevOps, legal, operations     |
| **2,085+ reference docs** | Decision guides, patterns catalogs, deep domain expertise     |
| **11+ templates**     | Production-ready assets and configurations                    |
...
| **Agent-Native Skills Library** | 188 skills across 27 domains for Claude Code, Copilot CLI, Cursor & more — the engine behind all my AI workflows | ✅ Live |
